...
@section('content')
<section>
    @include('cms.solution.modal.edit')
...
<script>
    ...
    $(document).ready(function () {
        ...
        let dataTable = $('#myTable').DataTable({
            "processing": true,
            "serverSide": true,
            "ajax": '{{ route('solutions.index') }}',
            "columns": [
                { "data": "thumbnail", "name": "thumbnail", "orderable": false, "searchable": false},
                { "data": "title", "name": "title", "render": renderWithDiv },
                { "data": "description", "name": "description", "render": renderWithDiv },
        ...
        $('#add-button').click(e => {
            $('.modal-title').html('Add Solutions');
            $('#myForm')[0].reset();
            $('#submit-button').show();
            $('#update-button').hide();
        ...
        $('#update-button').click(e => {
            ...
            axios.post(`solutions/${id}`, formData, {
                headers: {
                    'Accept': 'application/json',
                    'Content-Type': 'multipart/form-data'
                }
