...
@section('content')
<section>
    @include('cms.carousels.modal.edit')
...
<script>
    ...
    $(document).ready(function () {
        ...
        $('#update-button').click(e => {
            ...
            axios.post(`carousels/${id}`, formData, {
                headers: {
                    'Accept': 'application/json',
                    'Content-Type': 'multipart/form-data'
                }
